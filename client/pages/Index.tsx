  ...
  return (
    <div className="flex flex-col">
      <Helmet>
        ...
        <meta name="description" content="GamepadTest lets you use Gamepad Tester, Mic Tester, GPU Tester, and MIDI Tester online free — check all devices directly in your browser." />
        <meta name="keywords" content="GamepadTest, Gamepad Tester, Mic Tester, GPU Tester, MIDI Tester" />
  ...
  <div className="mx-auto max-w-7xl px-6 lg:px-8">
    <div className="mx-auto max-w-4xl animate-fade-in-up">
      <div className="text-center mb-16">
        <h2 className="text-3xl font-bold tracking-tight sm:text-5xl">GamepadTest – Free Online Hardware Testing Tools</h2>
        <p className="mt-6 text-xl leading-8 text-muted-foreground">
          Technology is the core of how we play, work, and create. From gaming sessions with friends to professional streaming, music production, or graphic-heavy projects, the performance of your hardware can make or break your experience.
        </p>
      </div>
      ...
      <div className="prose prose-lg max-w-none text-muted-foreground space-y-8">
        ...
        <div className="bg-white rounded-lg p-8 shadow-sm hover-lift transition-all duration-300 animate-fade-in-up animate-stagger-1">
          <p className="text-lg leading-relaxed">
            But like anything else, devices wear out. Controllers develop stick drift, graphics cards overheat, microphones cut out, and MIDI keyboards lose sensitivity. That's why we created GamepadTest — an all-in-one hub for free online testing tools.
          </p>
          <p className="text-lg leading-relaxed mt-4">
            With no downloads or installations, you can check your game controllers, GPUs, microphones, and MIDI devices instantly inside your web browser. We've built each tester to be fast, simple, and accurate so you can catch problems before they ruin your gaming session, work presentation, or recording.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-fade-in-up animate-stagger-2">
          <section className="hover-lift rounded-lg border bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-4 text-muted-foreground">
              <p>Most diagnostic software is heavy, complicated, or tied to a single brand. Our tools take a different approach: lightweight, browser-based testers that anyone can use. No technical knowledge required.</p>
              <p>Using our testers means you can run a gamepad tester in seconds to spot unresponsive buttons or drifting joysticks, perform a GPU tester benchmark to confirm stability, use a mic tester to ensure your audio is crisp, and verify your MIDI controllers respond correctly.</p>
            </div>
          </section>
          ...
          <section className="hover-lift rounded-lg border bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-4 text-muted-foreground">
              <p>Best of all, it's completely free. Whether you're a casual gamer, professional musician, or competitive player, our tools are available anytime, anywhere.</p>
              <p>The tool is also safe to use. It does not collect personal information or install extra software. Everything runs inside your browser and disappears once you close the page.</p>
            </div>
          </section>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-8 animate-fade-in-up animate-stagger-3">
          <h3 className="text-2xl font-bold mb-6 text-center text-foreground">Our Testing Tools</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center p-6 bg-white rounded-lg hover-scale transition-all duration-300">
              ...
              <h4 className="font-semibold text-foreground mb-2">Gamepad Tester</h4>
              <p className="text-sm">Check controllers for stick drift, button response, and connection issues. Supports PlayStation, Xbox, and PC gamepads.</p>
            </div>
            <div className="text-center p-6 bg-white rounded-lg hover-scale transition-all duration-300">
              <Monitor className="h-12 w-12 text-green-500 mx-auto mb-4" />
              <h4 className="font-semibold text-foreground mb-2">GPU Tester</h4>
              <p className="text-sm">Measure graphics card performance, check temperatures, and detect stability issues with real-time monitoring.</p>
            </div>
            <div className="text-center p-6 bg-white rounded-lg hover-scale transition-all duration-300">
              <Mic className="h-12 w-12 text-purple-500 mx-auto mb-4" />
              <h4 className="font-semibold text-foreground mb-2">Mic Tester</h4>
              <p className="text-sm">Test microphone quality, detect static or distortion, and ensure your audio is clear for calls and recordings.</p>
            </div>
            <div className="text-center p-6 bg-white rounded-lg hover-scale transition-all duration-300">
              <Music className="h-12 w-12 text-orange-500 mx-auto mb-4" />
              <h4 className="font-semibold text-foreground mb-2">MIDI Tester</h4>
              <p className="text-sm">Verify keyboard, pads, and controllers for correct note data, velocity sensitivity, and connection issues.</p>
            </div>
          </div>
        </div>
        ...
        <div className="animate-fade-in-up animate-stagger-4">
          <h3 className="text-2xl font-bold mb-8 text-center text-foreground">Comprehensive Testing Solutions</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Gamepad Testing", desc: "Detect stick drift, verify button response, test trigger sensitivity, and check for connection lag.", icon: Gamepad2 },
              { title: "GPU Performance", desc: "Real-time FPS monitoring, temperature tracking, stress testing, and performance dip detection.", icon: Monitor },
              { title: "Audio Quality", desc: "Live microphone input testing, static detection, volume level confirmation, and clarity assessment.", icon: Mic },
              { title: "MIDI Verification", desc: "Key and pad testing, velocity sensitivity checks, knob and fader validation, DAW connectivity.", icon: Music }
            ].map((feature) => (
        ...
        <div className="bg-blue-50 rounded-lg p-8">
          <h3 className="text-2xl font-bold mb-6 text-center text-foreground">Gamepad Tester – Check Controllers Instantly</h3>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div>
              <h4 className="font-semibold text-foreground mb-4">What You Can Test:</h4>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5" />
                  <span>Detect stick drift when a joystick moves on its own</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5" />
                  <span>Verify button response to confirm every press registers</span>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-green-500 mt-0.5" />
            ...
            <div>
              <h4 className="font-semibold text-foreground mb-4">Supported Controllers:</h4>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="hover-lift rounded-lg border bg-white p-6 shadow-sm">
            ...
            <h4 className="font-semibold text-foreground mb-3">GPU Tester – Free Online Graphics Card Checker</h4>
            <p className="text-sm mb-4">Your graphics card is the powerhouse of your system. When it struggles, you notice frame drops, overheating, or sudden crashes.</p>
          ...
          <div className="hover-lift rounded-lg border bg-white p-6 shadow-sm">
            ...
            <h4 className="font-semibold text-foreground mb-3">Mic Tester – Check Your Microphone Online</h4>
            <p className="text-sm mb-4">Eliminate guesswork by hearing your microphone's live input directly in your browser.</p>
            <ul className="text-sm space-y-2 text-muted-foreground">
          ...
          <div className="hover-lift rounded-lg border bg-white p-6 shadow-sm">
            ...
            <h4 className="font-semibold text-foreground mb-3">MIDI Tester – Keyboard, Pads & Controllers</h4>
            <p className="text-sm mb-4">Verify your equipment before recording or performing to ensure everything responds as expected.</p>
            <ul className="text-sm space-y-2 text-muted-foreground">
        ...
        <div className="bg-red-50 rounded-lg p-8">
          <h3 className="text-2xl font-bold mb-6 text-center text-foreground">Common Problems You Can Solve</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-red-500 rounded-full mt-2"></div>
                <div>
                  <h4 className="font-semibold text-foreground">Controller Issues</h4>
                  <p className="text-sm">Stick drift, unresponsive buttons, and connection problems.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-red-500 rounded-full mt-2"></div>
                <div>
                  <h4 className="font-semibold text-foreground">GPU Problems</h4>
                  <p className="text-sm">Crashes, overheating, poor frame rates, and performance dips.</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-red-500 rounded-full mt-2"></div>
                <div>
                  <h4 className="font-semibold text-foreground">Audio Troubles</h4>
                  <p className="text-sm">Mic silence, distortion, echo, or background noise.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-red-500 rounded-full mt-2"></div>
                <div>
                  <h4 className="font-semibold text-foreground">MIDI Failures</h4>
                  <p className="text-sm">Pads or keys failing to trigger, velocity issues, connection drops.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-green-50 rounded-lg p-8">
          <h3 className="text-2xl font-bold mb-6 text-center text-foreground">Who Can Benefit from GamepadTest?</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Gamers", desc: "Ensure flawless controller performance before online matches and tournaments." },
              { title: "Streamers", desc: "Maintain reliable mic and GPU performance for uninterrupted broadcasts." },
              { title: "Professionals", desc: "Test equipment before important video calls and presentations." },
              { title: "Musicians", desc: "Verify MIDI gear and audio equipment before recording sessions." }
            ].map((item, index) => (
        ...
        <div className="text-center bg-white rounded-lg p-8 shadow-sm">
          <h3 className="text-2xl font-bold mb-6 text-foreground">Why Choose GamepadTest Over Other Tools?</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
            {[
              { title: "Universal", desc: "Works with controllers, GPUs, mics, and MIDI devices in one place." },
              { title: "Free Forever", desc: "No subscriptions, no hidden charges, completely free to use." },
              { title: "Instant", desc: "Connect your device and see results right away with no delays." },
              { title: "User-Friendly", desc: "Designed for beginners and pros alike with intuitive interfaces." }
            ].map((feature) => (
              <div key={feature.title} className="hover-lift rounded-lg border bg-gray-50 p-6">
                <h4 className="font-semibold text-foreground mb-2">{feature.title}</h4>
                <p className="text-sm">{feature.desc}</p>
              </div>
            ))}
        ...
        <div className="text-center bg-primary text-white rounded-lg p-8">
          <h3 className="text-2xl font-bold mb-4">Start Testing Your Hardware Today</h3>
          <p className="text-lg mb-6">
            Your hardware is the foundation of your digital life. Don't let issues slow you down or cost you progress. With GamepadTest, you can run comprehensive tests anytime, all for free.
          </p>
